...
rock_font = load_font("assets/fonts/RockFont.ttf", 80)
cave_font = load_font("assets/fonts/CAVEMAN_.ttf", 32)

# Sounds
jump_snd = load_sound('assets/sounds/jump.ogg')
gem_snd = load_sound('assets/sounds/eat.ogg')
hurt_snd = load_sound('assets/sounds/dino_roar.ogg')

lost_music = "assets/sounds/lost.ogg"
won_music = "assets/sounds/yay.ogg"
start_music = "assets/sounds/stomping.ogg"



# Images
idle = load_image('assets/images/characters/dino_img.png')
walk = [load_image('assets/images/characters/dino_walk_img.png'),
        load_image('assets/images/characters/dino_walk_img.png')]
jump = load_image('assets/images/characters/dino_jump_img.png')
hurt = load_image('assets/images/characters/dead_dino_img.png')
...
tile_images = { "grass_tile_left": load_image('assets/images/tiles/tile_1.png'),
                "sand_tile_left": load_image('assets/images/old_tiles/1.png'),
                "sand_tile_right": load_image('assets/images/old_tiles/3.png'),
                "sand_tile_middle": load_image('assets/images/old_tiles/2.png'),
                "light_dirt_tile_middle": load_image('assets/images/old_tiles/5.png'),
                "light_dirt_platform_middle": load_image('assets/images/old_tiles/9.png'),
                "light_dirt_platform_left": load_image('assets/images/old_tiles/12.png'),
                "light_dirt_platform_right": load_image('assets/images/old_tiles/13.png'),
                "light_dirt_tile_left": load_image('assets/images/old_tiles/4.png'),
                "light_dirt_tile_right": load_image('assets/images/old_tiles/6.png'),
                "sand_platform_left": load_image('assets/images/old_tiles/14.png'),
                "sand_platform_middle": load_image('assets/images/old_tiles/15.png'),
                "sand_platform_right": load_image('assets/images/old_tiles/16.png'),
                "grass_tile_middle": load_image('assets/images/tiles/tile_2.png'),
                "grass_tile_right": load_image('assets/images/tiles/tile_3.png'),
                "dirt_tile_left": load_image('assets/images/tiles/tile_4.png'),
                "dirt_tile_middle": load_image('assets/images/tiles/tile_5.png'),
                "dirt_tile_right": load_image('assets/images/tiles/tile_6.png'),
                "grass_curved_platform_right": load_image('assets/images/tiles/tile_7.png'),
                "dirt_tile_2_middle": load_image('assets/images/tiles/tile_8.png'),
                "dirt_platform_middle": load_image('assets/images/tiles/tile_9.png'),
                "grass_curved_platform_left": load_image('assets/images/tiles/tile_11.png'),
                "dirt_platform_left": load_image('assets/images/tiles/tile_12.png'),
                "dirt_platform_right": load_image('assets/images/tiles/tile_16.png'),
                "grass_platform_left": load_image('assets/images/tiles/tile_13.png'),
                "grass_platform_middle": load_image('assets/images/tiles/tile_14.png'),
                "grass_platform_right": load_image('assets/images/tiles/tile_15.png'),
                "space_tile_left": load_image('assets/images/tiles/tileBlue_04.png'),
                "space_tile_middle": load_image('assets/images/tiles/tileBlue_05.png'),
                "space_tile_right": load_image('assets/images/tiles/tileBlue_06.png'),
                "space_platform_left": load_image('assets/images/tiles/tileBlue_26.png'),
                "space_platform_middle": load_image('assets/images/tiles/tileBlue_27.png'),
                "water_tile": load_image('assets/images/tiles/water_tile.png'),
                "space_top_tile": load_image('assets/images/tiles/tileBlue_07.png'),
                "bush": load_image('assets/images/items/bush_2.png'),
                "big_bush": load_image('assets/images/items/bigger_bush.png'),
                "tree": load_image('assets/images/items/tree_3.png'),
                "crate": load_image('assets/images/items/Crate.png'),
                "sign": load_image('assets/images/items/Sign_2.png'),
                "blue_tile": load_image('assets/images/tiles/blue_tile.png'),
                "cactus1": load_image('assets/images/items/cactus1.png'),
                "cactus2": load_image('assets/images/items/cactus2.png'),
                "stone": load_image('assets/images/items/stone.png'),
                "stump": load_image('assets/images/items/tree_1.png'),
                "sand_tree": load_image('assets/images/items/sand_tree.png')}
            
basic_enemy_images = [ load_image('assets/images/characters/basic_enemy1.png'),
                       load_image('assets/images/characters/basic_enemy2.png') ]

space_enemy_images = [    load_image('assets/images/characters/p1_walk01.png'),
                          load_image('assets/images/characters/p1_walk02.png'),
                          load_image('assets/images/characters/p1_walk03.png'),
                          load_image('assets/images/characters/p1_walk04.png'),
                          load_image('assets/images/characters/p1_walk05.png'),
                          load_image('assets/images/characters/p1_walk06.png'),
                          load_image('assets/images/characters/p1_walk07.png'),
                          load_image('assets/images/characters/p1_walk08.png'),
                          load_image('assets/images/characters/p1_walk09.png'),
                          load_image('assets/images/characters/p1_walk10.png'),
                          load_image('assets/images/characters/p1_walk11.png')]

platform_enemy_images = [ load_image('assets/images/characters/advanced_enemy1.png'),
                          load_image('assets/images/characters/advanced_enemy4.png'),
                          load_image('assets/images/characters/advanced_enemy2.png'),
                          load_image('assets/images/characters/advanced_enemy5.png'),
                          load_image('assets/images/characters/advanced_enemy3.png'),
                          load_image('assets/images/characters/advanced_enemy6.png')] 

item_images = { "Gem": load_image('assets/images/items/mushroom2.png'),
                "Cherry": load_image('assets/images/items/cherry.png'),
                "mega_mush": load_image('assets/images/items/mega_mush.png')}

starter_img = load_image('assets/images/backgrounds/start_background.png')
...
class Level():
    ...
    def load_enemies(self):
        ...
        for element in self.map_data['enemies']:
            ...
            elif kind == "SpaceEnemy":
                s = SpaceEnemy(x, y, space_enemy_images)
...
class Game():
    ...
    def show_title_screen(self):
        ...
        text = rock_font.render(TITLE, 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 212
        screen.blit(text, rect)

        text = cave_font.render("Press space to start.", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
    ...
    def show_cleared_screen(self):
        text = rock_font.render("Level cleared", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
    ...
    def show_win_screen(self):
        text = rock_font.render("You win", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
    ...
    def show_lose_screen(self):
        text = rock_font.render("You lose", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
    ...
    def show_stats(self):
        ...
        text = cave_font.render(level_str, 1, BLACK)
        rect = text.get_rect()
        rect.left = 24
        rect.top = 24
        screen.blit(text, rect)
        ...
        text = cave_font.render(score_str, 1, BLACK)
        rect = text.get_rect()
